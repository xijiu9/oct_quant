...
def add_parser_arguments(parser):
    ...
    parser.add_argument('--abits', type=int, default=4, help='activation number of bits')
    parser.add_argument('--wbits', type=int, default=4, help='weight number of bits')
...
def main(args):
    ...
    if args.seed is not None:
        ...
        set_seed_epoch(args.seed + args.local_rank, 0)
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            print("checkpoint from epoch {}".format(args.start_epoch))
