...
# for epoch in [90, 75, 20, 1, 0]:
#     for bit in [4, 5, 6, 7, 8]:
#         os.makedirs("20221025/imagenet/{}/{}".format(epoch, bit), exist_ok=True)
#
#         os.system("python train_imagenet.py --b 100 --obs 800 --lr 0.8 --arch resnet18 --training-bit plt --plt-bit "
...
#     os.system("python train_imagenet.py --b 100 --obs 800 --lr 0.8 --arch resnet18 "
